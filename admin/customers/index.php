        ...
        <div class="card-body">
            <div class="row">
                <div class="col-12 mb-3">
                    <a href="<?php echo $burl . "/admin/customers/create.php?"?>" class="btn btn-success"><i
            ...
            <table class="table table-hover table-sm table-bordered text-center">
                ...
                <tbody class="align-middle">
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="<?php echo $burl . "/admin/customers/edit.php?customer_id=" . $customer->id ?>"
                                class="btn btn-success"><i class="fa-solid fa-pen"></i> Edit</a>
                            <a href="<?php echo $burl . "/admin/customers/actions/delete.php?customer_id=" . $customer->id ?>"
                    ...
                    <nav aria-label="Page navigation example">
                        <ul class="pagination">
                            <li class="page-item <?php echo $page - 1 == 0  ? 'disabled' : '' ?>"><a class="page-link"
                                    href="<?php echo $burl . "/admin/customers/index.php?page=" . $page - 1 ?>">Previous</a>
                            </li>
                            <?php for($i=1; $i<=$totalPage; $i++){ ?>
                            <li class="page-item <?php echo $page == $i ? 'active' : '' ?>">
                                <a class="page-link"
                                    href="<?php echo $burl . "/admin/customers/index.php?page=" . $i; ?>"><?php echo $i; ?></a>
                            </li>
                            <?php }?>
                            <li class="page-item <?php echo $page +1 > $totalPage ? 'disabled' : '' ?>"><a
                                    class="page-link"
                                    href="<?php echo $burl . "/admin/customers/index.php?page=" . $page + 1 ?>">Next</a>
                            </li>
                        </ul>
                    </nav>
                </div>
