...
<div class="container pt-4">
    <div class="card">
        ...
        <div class="card-body">
            ...
            <form action="<?php echo $burl . "/admin/product_categorys/actions/edit.php"; ?>" method="post"
                ...
                <div class="mb-3">
                    <img src="<?php echo $base_url . $category -> photo ?>" width="150px" height="150px" alt="IMG">
